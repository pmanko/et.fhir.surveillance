# Confirmatory Syphilis Test Type ValueSet - Ethiopia Surveillance IG (sandbox demo subset) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.et/surveillance/ValueSet/syphilis-confirmatory-test-type-vs | *Version*:0.1.0 |
| Draft as of 2026-06-17 | *Computable Name*:SyphilisConfirmatoryTestTypeVS |
...
```json
{
  ...
  "url" : "http://fhir.et/surveillance/ValueSet/syphilis-confirmatory-test-type-vs",
  "version" : "0.1.0",
  ...
  "compose" : {
    "include" : [{
      "system" : "http://fhir.et/surveillance/CodeSystem/syphilis-confirmatory-test-type-cs"
    }]
  }
}
