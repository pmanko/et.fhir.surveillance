# STI Test Result ValueSet - Ethiopia Surveillance IG (sandbox demo subset) v0.1.0
...
| | |
| :--- | :--- |
| *Official URL*:http://fhir.et/surveillance/ValueSet/sti-result-vs | *Version*:0.1.0 |
| Draft as of 2026-06-17 | *Computable Name*:STIResultVS |
...
```json
{
  ...
  "id" : "sti-result-vs",
  "url" : "http://fhir.et/surveillance/ValueSet/sti-result-vs",
  "version" : "0.1.0",
  "name" : "STIResultVS",
  ...
  "compose" : {
    "include" : [{
      "system" : "http://fhir.et/surveillance/CodeSystem/sti-result-cs"
    }]
  }
}
